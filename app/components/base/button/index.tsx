...
const Button: FC<IButtonProps> = ({
  ...
  switch (type) {
    case 'primary':
      ...
      break
    default:
      style = disabled ? 'border-solid border border-gray-200 dark:border-slate-600 bg-gray-200 cursor-not-allowed text-gray-800' : 'border-solid border border-gray-200 dark:border-slate-600 cursor-pointer text-gray-500 hover:bg-white dark:hover:bg-slate-700 dark:bg-slate-800 hover:shadow-sm hover:border-gray-300 dark:hover:border-slate-600'
      break
  }
