    ...
    <Uploader onUpload={onUpload} disabled={disabled} limit={limit}>
      {
        hovering => (
          <div className={`
            ...
            ${hovering && 'bg-gray-100 dark:bg-slate-700'}
          `}>
  ...
  return (
    ...
    >
      <PortalToFollowElemTrigger onClick={handleToggle}>
        <div className={`
          relative flex items-center justify-center w-8 h-8 hover:bg-gray-100 dark:hover:bg-slate-700 rounded-lg
      ...
      <PortalToFollowElemContent className='z-50'>
        <div className='p-2 w-[260px] bg-white dark:bg-slate-800 rounded-lg border-[0.5px] border-gray-200 dark:border-slate-600 shadow-lg'>
